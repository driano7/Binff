      ...
      cards: [
        {
          ...
          facts: [
            { label: "Ideal para", value: "Tester une nouvelle idée." },
            { label: "Pages", value: "1 (Landing Page)." },
            { label: "Reviews", value: "No." },
            { label: "SEO", value: "Basic Indexing." },
          ],
          includes: ["5 images", "2 POC/CTA"],
          excludes: ["Advanced SEO", "Multi-page structure"],
        ...
        },
        {
          ...
          facts: [
            { label: "Ideal para", value: "Faire grandir une vraie entreprise." },
            { label: "Pages", value: "5 (Site complet)." },
            { label: "Reviews", value: "3 rounds." },
            { label: "SEO", value: "Basic Indexing." },
          ],
          includes: ["15 images", "2 themes", "2 languages", "5 POC/CTA"],
          excludes: ["Custom app flows", "Advanced automation", "Full e-commerce build"],
        ...
        },
        {
          ...
          facts: [
            { label: "Ideal para", value: "D’autres types de sites." },
            { label: "Pages", value: "Custom." },
            { label: "Reviews", value: "By request." },
            { label: "SEO", value: "Custom." },
          ],
